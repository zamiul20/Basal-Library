...
Directories:
1. \bin\ - executables for the app .apk and .zip (many files acommpanying the .exe)
2. \cod\ - code for the app, for the .NET MAUI framework, with its own version of Basal.cs
3. \usage\ - How to operate the app

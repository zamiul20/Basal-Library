...
public partial class Calculus : ContentPage
{
	public Calculus()
	{
		InitializeComponent();
    ...
    public void conver(object?sender, EventArgs e)
    {
        ...
        double value = leinbas.disintegrate(innum, leinbas);

        leoutbas = new Basal(value, leoutbas.base_value, leoutbas.polar, leoutbas.discretion, leoutbas.echo, leoutbas.ripple, leoutbas.velocity);
